        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQWufCbQIEvK65qi5XJngs46TwhTXkxD9WixA&s", "Eagle's Nest" },
                    { 3, 1, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTjrQw2OqVFvfUNsxFtV8WxJp_2jDSAyCWUcQ&s", "Whispering Pines" },
                    { 4, 3, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjPWuwPtSasA14j9YFXBExdChO6H71O86UXA&s", "Mountain View" },
                    { 5, 2, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRI7zg34cxtzzFBqisoCFwj-xqDepr09UBfVw&s", "Riverbend Retreat" },
                    { 6, 3, "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTFZD-Tg-t4UUkVgW0nIjNND8XtwZQAbPz9Aw&s", "Sunny Meadow" }
                });

            migrationBuilder.InsertData(
                table: "Reservations",
                columns: new[] { "Id", "CampsiteId", "CheckinDate", "CheckoutDate", "UserProfileId" },
                values: new object[] { 1, 1, new DateTime(2024, 9, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 9, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 });
